...
return array(
	'ctrl' => array(
		'title'	=> 'LLL:EXT:dsachars/Resources/Private/Language/locallang_db.xlf:tx_dsachars_domain_model_character',
		'label' => 'name',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_dsachars_domain_model_character',
				'foreign_table_where' => 'AND tx_dsachars_domain_model_character.pid=###CURRENT_PID### AND tx_dsachars_domain_model_character.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dsachars/Resources/Private/Language/locallang_db.xlf:tx_dsachars_domain_model_character.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
